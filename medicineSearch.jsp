        ...
        <section id="about">
            <div class="container">
                <header class="section-header">
                    <h3 style="color:white"><%=dataBundle.getString("index_searchmedicine")%> </h3>
                </header>
                <div class="container">
                    <form action="FrontController" method="post"><fieldset>
                            <input type="search" name="name" placeholder="Search.." /><button type="submit"><i class="fa fa-search"></i></button></fieldset>  <input type="hidden" name ="action" value="Search" /></form>
                    <table class="table">
                        <thead>
                            <tr>
                                <th><%=dataBundle.getString("index_listofdrugs")%></th>
                        ...
                        <tbody>
                            <tr>
                                <td> <a href="druginfo.jsp?name=<%=b.getName()%>"><%=b.getName()%></a> </td>
