...
<html lang="en">
  ...
  <div class="se-pre-con"></div>
        ...
        <header id="header">
            <div class="container-fluid">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active" style="color:lightblue"><a href="SearchConditions.jsp"><%=dataBundle.getString("backtosearch")%></a></li>
     ...
     About Us Section
   ============================-->
        <section id="about" style="background-image: url('img/med.jpg');">
            <div class="container">
                ...
                <header class="section-header">
                    <%
                            ...
                            if (title != null && !title.equals("")) {
                                PossibleconditionDetailDao codDao = new PossibleconditionDetailDao("healthybunny");
                                ArrayList<Possibleconditions_details> cond = codDao.getConditionsDetailbyName(title);
                                for (Possibleconditions_details m : cond) {
                    ...
                    <div class="container">
                        ...
                        <header class="section-header wow fadeInUp">
                            <h3 style="color:lightblue"> <%=m.getTitle()%></h3>
                        </header>
                        ...
                        <div class="tabs">
                            <div class="tab">
                                <button class="tab-toggle"><%=dataBundle.getString("howCommon")%></button>
                            </div>
                            <div class="content">
                                <h3 class="heading"></h3>
                                <p class="description"><%=m.getHowCommon()%></p>
                            </div>
                            <div class="tab">
                                <button class="tab-toggle"><%=dataBundle.getString("diagnosedby")%></button>
                            </div>
                            <div class="content">
                                <h3 class="heading"></h3>
                                <p class="description"><%=m.getDiagnosedBy()%></p>
                            </div>
                            <div class="tab">
                                <button class="tab-toggle"><%=dataBundle.getString("treatment")%></button>
                            </div>
                            <div class="content">
                                <h3 class="heading"></h3>
                                <p class="description"><%=m.getTreatment()%></p>
                            </div>
                            <div class="tab">
                                <button class="tab-toggle"><%=dataBundle.getString("madeworseby")%></button>
                            </div>
                            <div class="content">
                                <h3 class="heading"></h3>
                                <p class="description"><%=m.getMadeWorseBy()%></p>
                            </div>
                            <div class="tab">
                                <button class="tab-toggle"><%=dataBundle.getString("fact")%></button>
                            </div>
                            <div class="content">
                                <h3 class="heading"></h3>
                                <p class="description"><%=m.getFact()%></p>
                            </div>
