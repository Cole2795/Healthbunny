        ...
        <section id="about" style="background-image: url('img/med.jpg');">
            <div class="container">
                <header class="section-header">
                    <h3 style="color:white"><%=dataBundle.getString("index_searchcondition")%> </h3>
                </header>
                <div class="container">
                    <form action="FrontController" method="post"><fieldset>
                            <input type="search" name="title" placeholder="Search.." autocomplete="on"/><button type="submit"><i class="fa fa-search"></i></button></fieldset><input type="hidden" name ="action" value="search" /></form>
                    <table class="table">
                        <thead>
                            <tr>
                                <th><%=dataBundle.getString("index_listofconditions")%></th>

                            </tr>
                        </thead>
                        <%
                            PossibleconditionDetailDao medDao = new PossibleconditionDetailDao("healthybunny");
                            ArrayList<Possibleconditions_details> cond = medDao.getallConditionsDetailsList();
                        %>
                        <%
                            for (Possibleconditions_details b : cond) {
                        %>
                        <tbody>
                            <tr>
                                <td> <a href="conditioninfo.jsp?title=<%=b.getTitle()%>"><%=b.getTitle()%></a> </td>
