        ...
        <section id="about" style="background-image: url('img/med.jpg');">
            <div class="container">
                ...
                <header class="section-header">
                    <%
                            ArrayList<Possibleconditions_details> searchCondition = (ArrayList<Possibleconditions_details>) session.getAttribute("searchs");
                            if (searchCondition != null) {
                                for (Possibleconditions_details m : searchCondition) {
                        %>
                    <div class="container">
